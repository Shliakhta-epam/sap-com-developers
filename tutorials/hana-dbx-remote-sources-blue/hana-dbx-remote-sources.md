...
time: 25
tags: [ tutorial>beginner, products>sap-hana, topic>ABAP Development, topic>big-data, topic>sql, products>SAPUI5]
...
---
#         Accsess Tutorial for Test Blue
<!-- description --> Use 
...
5. Open the virtual table `VT_TOURIST_REVIEWS` and notice that its type is virtual.
    ...
    <!-- border; size:1000px --> ![table editor](table_editor.png)
